...
#include "tools/PDB.h"
#include "reference/IntermolecularDRMSD.h"
...
class IntermolecularDRMSD : public Colvar {

  bool pbc_;
  MultiValue myvals;
  ReferenceValuePack mypack;
  PLMD::IntermolecularDRMSD* drmsd_;

public:
  IntermolecularDRMSD(const ActionOptions&);
  ~IntermolecularDRMSD();
  virtual void calculate();
  static void registerKeywords(Keywords& keys);
};

PLUMED_REGISTER_ACTION(IntermolecularDRMSD,"INTERDRMSD")

void IntermolecularDRMSD::registerKeywords(Keywords& keys){
...
IntermolecularDRMSD::IntermolecularDRMSD(const ActionOptions&ao):
PLUMED_COLVAR_INIT(ao), pbc_(true), myvals(1,0), mypack(0,0,myvals)
{
  ...
  drmsd_= new PLMD::IntermolecularDRMSD( ro );
...
IntermolecularDRMSD::~IntermolecularDRMSD(){
  delete drmsd_;
}

// calculator
void IntermolecularDRMSD::calculate(){
